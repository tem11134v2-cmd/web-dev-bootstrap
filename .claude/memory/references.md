---
name: references
description: Реестр ID/URL внешних сервисов и путей проекта. НИКОГДА не секреты
type: reference
---

# Внешние ресурсы и ID проекта

Реестр ID/URL внешних сервисов (**НИКОГДА секреты** — токены, пароли, ключи только в `.env`).
Описания интеграций — `docs/integrations.md`; здесь только идентификаторы, URL и пути.
