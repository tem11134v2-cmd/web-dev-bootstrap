...
- [business.md](business.md) — коммерческие факты, узнанные по ходу: цены, воронка, конверсия, возражения
...
Правило заголовков: **заголовок записи — утверждение, не категория.**
«Лиды с квиза конвертятся в 2 раза лучше формы» находится по одному заголовку;
«конверсия» заставляет открывать и читать файл целиком.
